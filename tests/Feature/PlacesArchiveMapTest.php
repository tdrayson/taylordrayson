...
it('exposes deduped check-in places for the archive overview map', function () {
    ...
    Place::factory()->create(['latitude' => 51.5074, 'longitude' => -0.1278, 'venue_name' => 'A']);
    Place::factory()->create(['latitude' => 51.5074, 'longitude' => -0.1278, 'venue_name' => 'A again']);
    Place::factory()->create(['latitude' => 52.4862, 'longitude' => -1.8904, 'venue_name' => 'B']);
