...
it('attaches heart-rate to the matching activity and mirrors only its CSV row', function () {
    ...
    $header = 'occurred_at,type,name,duration,calories,distance_km,average_heart_rate,max_heart_rate,heart_rate,platform_type,platform_id,meta';
...
it('merges batched payloads into one series and defends the prior peak', function () {
    ...
    file_put_contents($csvPath, "occurred_at,type,name,duration,calories,distance_km,average_heart_rate,max_heart_rate,heart_rate,platform_type,platform_id,meta\n"
