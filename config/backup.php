    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                /*
                 * Empty on purpose: this backs up the database only. Assets are
                 * mirrored to R2 by assets:mirror instead, because every
                 * backup:run is a full zip and keeping several copies of the
                 * same 1.3GB of write-once images buys nothing. See #44.
                 */
                'include' => [],
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                // Database-only backups are ~8MB, so anything near this ceiling
                // means something is being included that should not be.
