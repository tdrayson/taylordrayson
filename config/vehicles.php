...
| map. `Fuel::getVehicleAttribute()` resolves it, `TypeRegistry` uses `name`
| as the vehicle filter label, and `FuelStory` reads `make`/`model`. Adding a
| second car is just another entry here (mark the previous one
