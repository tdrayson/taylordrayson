...
/**
 * The `tv_shows.meta` column, typed: show-level counts from Trakt plus the TMDB
 ...
 */
final readonly class TvShowMeta implements Arrayable, Castable, JsonSerializable
{
