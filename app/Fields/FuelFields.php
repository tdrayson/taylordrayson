 ...
 *
 * `litres` is absent because it is computed, see {@see DeriveFuelFigures}.
 */
final class FuelFields
{
    ...
    public static function fields(): array
    {
        return [
            ...
            FieldData::optional('brand', 'Brand', FieldType::Lookup, source: 'fuel-brand', sidebar: true),
            FieldData::optional('fuel_card_cost', 'Fuel card cost', FieldType::Number, prefix: '£', sidebar: true),
