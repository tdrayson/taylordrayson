...
abstract class StreakMeasure extends DynamicTag
{
    ...
    {
        return [
            new TagOption('type', 'Type', array_column(TimelineType::cases(), 'value'), TimelineType::Food->value),
    ...
    {
        $model = TypeRegistry::find($options['type'] ?? TimelineType::Food->value)['model'] ?? null;
