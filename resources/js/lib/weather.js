...
const G = {
    ...
    blueGrey:
        "radial-gradient(circle at 32% 30%, #B6CBE4, #5A7BA8 54%, #324C6E)",
    darkBlue:
        "radial-gradient(circle at 32% 30%, #8FA8C8, #3E5C82 54%, #1E3354)",
    ice: "radial-gradient(circle at 32% 30%, #BEE7FF, #4FA8F5 54%, #1E5AD0)",
    whiteBlue:
        "radial-gradient(circle at 32% 30%, #FFFFFF, #CBE6FF 54%, #8FBEE8)",
    iceGrey:
        "radial-gradient(circle at 32% 30%, #E8EEF5, #AFC2D6 54%, #7C93AC)",
    ...
    sunRain:
        "radial-gradient(circle at 32% 30%, #FFE0A3, #79A7D8 54%, #3E6FA8)",
};
...
export const CONDITIONS = {
    clear: {
        label: "Clear",
        line: "Clear skies. Make the most of it.",
        icon: Sun03Icon,
        t: 22,
        gradient: G.clear,
    },
    ...
    "partly-cloudy": {
        label: "Partly Cloudy",
        line: "A bit of cloud, nothing dramatic.",
        icon: SunCloud02Icon,
        t: 18,
        gradient: G.grey,
    },
    ...
    "blowing-dust": {
        label: "Blowing Dust",
        line: "Grit in your teeth weather.",
        icon: FastWindIcon,
        t: 24,
        gradient: G.tan,
    },
    ...
    drizzle: {
        label: "Drizzle",
        line: "That annoying not-quite-rain.",
    ...
    rain: {
        label: "Rain",
        line: "Tipping it down, naturally.",
        icon: CloudRainIcon,
        t: 12,
        gradient: G.blueGrey,
    },
    ...
    "sun-showers": {
        label: "Sun Showers",
        line: "Sunny and raining. Pick one.",
        icon: SunCloudLittleRain01Icon,
        t: 16,
        gradient: G.sunRain,
    },
    "freezing-drizzle": {
        label: "Freezing Drizzle",
        line: "Drizzle, but it bites.",
        icon: CloudDrizzleIcon,
        t: 1,
        gradient: G.ice,
    },
    ...
    "isolated-thunderstorms": {
        ...
        line: "The odd rumble about.",
        icon: SunCloudAngledRainZap01Icon,
        t: 19,
        gradient: G.purple,
    },
    "scattered-thunderstorms": {
        label: "Scattered Thunderstorms",
        line: "Storms dotted around.",
    ...
    thunderstorms: {
        label: "Thunderstorms",
        line: "Best stay inside for this.",
    ...
    flurries: {
        label: "Flurries",
        line: "A few flakes drifting down.",
        icon: CloudLittleSnowIcon,
        t: 0,
        gradient: G.whiteBlue,
    },
    snow: {
        label: "Snow",
        line: "Snow. Cold but pretty.",
        icon: CloudSnowIcon,
        t: -1,
        gradient: G.whiteBlue,
    },
    "heavy-snow": {
        label: "Heavy Snow",
        line: "Properly dumping it down.",
        icon: CloudMidSnowIcon,
        t: -3,
        gradient: G.whiteBlue,
    },
    "sun-flurries": {
        label: "Sun Flurries",
        line: "Snowing in the sunshine.",
        icon: SunCloudLittleSnow01Icon,
        t: 1,
        gradient: G.whiteBlue,
    },
    sleet: {
        label: "Sleet",
        line: "Snow's miserable cousin.",
        icon: CloudHailIcon,
        t: 1,
        gradient: G.iceGrey,
    },
    hail: {
        label: "Hail",
        line: "Ice pellets from above.",
        icon: CloudHailstoneIcon,
        t: 4,
        gradient: G.iceGrey,
    },
    "wintry-mix": {
        label: "Wintry Mix",
        line: "Everything at once. Lovely.",
        icon: CloudMidSnowIcon,
        t: 0,
        gradient: G.iceGrey,
    },
    ...
    foggy: {
        label: "Foggy",
        line: "Can't see a thing out there.",
        icon: CloudFogIcon,
        t: 9,
        gradient: G.grey,
    },
    ...
    hot: {
        label: "Hot",
        line: "Hot. Try not to melt.",
        icon: ThermometerWarmIcon,
        t: 34,
        gradient: G.hot,
    },
    ...
    "tropical-storm": {
        ...
        line: "Wind and water, lots of it.",
        icon: Tornado02Icon,
        t: 22,
        gradient: G.dark,
    },
