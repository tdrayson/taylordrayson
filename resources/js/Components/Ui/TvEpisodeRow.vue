...
<template>
    ...
    >
        <span class="flex min-w-0 items-baseline gap-3">
            <span class="shrink-0 text-caption font-semibold text-neutral-500 tabular-nums">{{ code }}</span>
        ...
        <span class="flex shrink-0 items-center gap-3">
            ...
            <time v-if="watchTime" :datetime="occurredAt" class="text-caption text-neutral-500 tabular-nums">{{ watchTime }}</time>
        </span>
    </Link>
</template>
