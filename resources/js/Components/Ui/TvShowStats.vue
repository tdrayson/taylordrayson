...
const props = defineProps({
    // Shape from TvShowWatchStats: episodesWatched and totalHours are always
    // present; seasons/progress/watchSpan may be null (or absent entirely at
    // season scope, where they don't apply).
...
<template>
    <StatGrid data-testid="tv-show-stats" :stats="items" />
</template>
