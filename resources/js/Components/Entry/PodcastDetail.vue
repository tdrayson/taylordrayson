...
<template>
    <div class="space-y-8">
        ...
        <div v-if="entry.topic">
            ...
            <p class="max-w-reading text-body text-neutral-700">{{ entry.topic }}</p>
        </div>

        <Accordion v-if="entry.show_notes" title="Show Notes">
            <div class="show-notes max-w-reading whitespace-pre-line text-body text-neutral-700" v-html="entry.show_notes"></div>
        </Accordion>
    </div>
</template>
