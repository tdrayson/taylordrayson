...
<template>
    <div class="flex items-center justify-between gap-4">
        <span class="text-base text-neutral-900">{{ label }}</span>
        <div
            role="radiogroup"
        ...
        >
            ...
            >
                ...
                >
                <span
                    class="block rounded-md px-3 py-1 text-xs font-semibold text-neutral-500 transition-colors duration-150 peer-hover:text-neutral-900 peer-checked:bg-accent-500 peer-checked:text-neutral-0 peer-focus-visible:outline-2 peer-focus-visible:outline-accent-500"
                >{{ option.label }}</span>
            </label>
        </div>
    </div>
