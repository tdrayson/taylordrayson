        ...
        <div class="mt-3 flex max-w-md items-center gap-4">
            <div class="tile-border flex w-20 shrink-0 flex-col overflow-hidden rounded-xl border">
                ...
                <div class="flex flex-col items-center justify-center gap-0.5 p-2">
                    <time :datetime="start.iso" class="tile-day font-display text-stat leading-none tabular-nums">{{ start.day }}</time>
            ...
            <div class="tile-border flex w-20 shrink-0 flex-col overflow-hidden rounded-xl border">
                ...
                <div class="flex flex-col items-center justify-center gap-0.5 p-2">
                    <time :datetime="end.iso" class="tile-day font-display text-stat leading-none tabular-nums">{{ end.day }}</time>
