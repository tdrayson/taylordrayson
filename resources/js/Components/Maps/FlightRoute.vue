...
<template>
    <div class="flex items-center justify-between gap-4">
        <div class="shrink-0">
            ...
            <div v-if="!compact && origin.city" class="text-caption text-neutral-500">{{ origin.city }}</div>
        </div>
        ...
        <div class="shrink-0 text-right">
            ...
            <div v-if="!compact && destination.city" class="text-caption text-neutral-500">{{ destination.city }}</div>
        </div>
    </div>
</template>
