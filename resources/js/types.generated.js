...
export const timelineTypes = {
    ...
    film: { icon: 'Film01Icon', label: 'Film', plural: 'Films', href: '/films', accent: 'film', keywords: 'watch movie film', noun: 'film', nounPlural: 'films', kind: 'watching' },
    episode: { icon: 'Tv01Icon', label: 'Episode', plural: 'TV', href: '/tv', accent: 'episode', keywords: 'watch tv show episode series', noun: 'episode', nounPlural: 'episodes', kind: 'watching' },
    book: { icon: 'BookOpen01Icon', label: 'Book', plural: 'Books', href: '/books', accent: 'book', keywords: 'read book reading', noun: 'book', nounPlural: 'books', kind: 'watching' },
