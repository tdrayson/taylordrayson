        ...
        <div class="mx-auto flex max-w-sm flex-col px-6 py-8">
            ...
            <Transition name="rise" mode="out-in" @enter="focusHeading">
                <div v-if="!sent">
                    ...
                    <DetailsForm :fields="FIELDS" class="mt-8" @sent="sent = true" />
                </div>
                ...
                <div v-else class="mt-16 flex flex-col">
                    ...
                    <button type="button" class="mt-6 font-display text-lg font-semibold text-accent-600 hover:underline" @click="sent = false">
                        Back to the form
                    </button>
                </div>
            </Transition>
